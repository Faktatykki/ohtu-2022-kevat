...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_sama_nimi_kuin_tuotteella_ja_lukumaara_2(self):
        maito = Tuote("Maito", 3)
    ...
    def test_korissa_kaksi_samaa_tuotetta_toinen_poistetaan_jaa_koriin_1_kpl_tuotetta(self):
        maito = Tuote("Maito", 3)
